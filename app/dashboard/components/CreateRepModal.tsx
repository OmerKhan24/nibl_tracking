...
export function CreateRepModal({ open, onClose, onCreated }: { open: boolean, onClose: () => void, onCreated: () => void }) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const res = await fetch('/api/team/reps', {
      method: 'POST',
    ...
    if (!res.ok) {
      ...
      setError(err.error || 'Failed to create rep')
    } else {
      onCreated()
      onClose()
  ...
  return (
    <Modal open={open} onClose={onClose} title="Create Sales Rep">
